...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _label.font = [UIFont fontWithName:@"Futura-BookItalic" size:16];
        ...
        NSArray *imageVerticalConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(==4)-[_imageView(==40)]-(==4)-|" options:0 metrics:nil views:views];
        [self addConstraints:imageVerticalConstraints];
        
        NSLayoutConstraint *labelVerticalConstraint = [NSLayoutConstraint constraintWithItem:_label attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:_imageView attribute:NSLayoutAttributeCenterY multiplier:1 constant:0];
