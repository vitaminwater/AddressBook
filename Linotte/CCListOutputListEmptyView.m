...
- (void)setupAddressListButton
{
    ...
    _addressListButton.layer.cornerRadius = 20;
...
- (void)setupLayout
{
    ...
    NSArray *verticalConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_helpLabel]-(==20)-[_addressListButton(==40)]|" options:0 metrics:nil views:views];
